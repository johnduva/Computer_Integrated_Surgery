...
if verify(m, v_set, .01)
    ...
    while count < 7
        ...
        while n_mm < 30
            ...
            for ck = 1 : N      
                ...
                % Build m_s
                [m_s, m_ms] = get_deformed_coord(m, s, m_lams_curr);

                % Build m_t
                [m_t, m_mt] = get_deformed_coord(m, t, m_lams_curr);

                % Build m_u
                [m_u, m_mu] = get_deformed_coord(m, u, m_lams_curr);
                ...
                q_0k = (lambda * m(1,s)) + (mu * m(1,t)) + (v * m(1,u));
    ...
    save(strcat(file_alphabet, '_mode_weights.mat'), 'm_lams');
